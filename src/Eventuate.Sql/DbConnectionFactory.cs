...
namespace Eventuate.Sql
{
    internal static class DbConnectionFactory
    {
        ...
        {
            var connectionType = GetProviderType(providerName);
            return Create(connectionString, connectionType);
        }

        public static Func<DbConnection> Create(string connectionString, Type connectionType)
        {
        ...
        /// <summary>
        /// Returns a type - which must inherit from <see cref="DbConnection"/> - which matches provided <paramref name="providerName"/>.
        internal static Type GetProviderType(string providerName)
        {
            string typeName = "";
